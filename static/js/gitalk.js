!(function(e, t) {
  'object' == typeof exports && 'object' == typeof module
    ...
    ? (exports.Gitalk = t(require('React'), require('ReactDOM')))
    : (e.Gitalk = t(e.React, e.ReactDOM))
})(this, function(e, t) {
  return (function(e) {
    function t(r) {
      ...
      function r(e, t) {
        ...
        if (v) {
          ...
          return (
            ...
            c.timezone
              ? (g = s(c.timezone))
              : ((g = new Date(y + b).getTimezoneOffset()),
                (g = new Date(y + b + g * d).getTimezoneOffset())),
            new Date(y + b + g * d)
          )
        }
        return new Date(e)
    ...
    function(e, t, n) {
      ...
      e.exports = function(e, t, n, h, m, v, g) {
        ...
        var y,
          ...
          N = C || x(m),
          O = m ? (E ? x('entries') : N) : void 0,
          T = 'Array' == t ? M.entries || C : C
        if (
          (T &&
            (w = l(T.call(new e()))) !== Object.prototype &&
            w.next &&
            (c(w, _, !0), r || 'function' == typeof w[f] || a(w, f, p)),
          E &&
            C &&
            'values' !== C.name &&
            ((S = !0),
    ...
    function(e, t, n) {
      ...
      t.default = function(e) {
        ...
        return o.default.createElement(
          ...
          o.default.createElement('img', { src: t, alt: '@' + r })
        )
      }
    },
    function(e, t, n) {
      ...
      t.default = function(e) {
        ...
        return o.default.createElement(
          ...
          o.default.createElement('span', {
            className: 'gt-svg',
            dangerouslySetInnerHTML: { __html: n(172)('./' + i + '.svg') }
          }),
            ...
            (0, u.default)(e, [
              {
                ...
                value: function(e, t) {
                  var n = null
                  if (!(e = e || this.options.container))
                    throw new Error('Container is required: ' + e)
                  if (e instanceof HTMLElement) n = e
                  else if (!(n = window.document.getElementById(e)))
                    throw new Error(
                      'Container not found, window.document.getElementById: ' +
                        e
                    )
                  return (
                    t || (t = function() {}),
      ...
      var C = n(71),
        ...
        R = (function(e) {
          function t(e) {
            ...
            ;(n.state = {
                    ...
                    return C.axiosGithub
                      ...
                      .then(function(e) {
                        var t = n.state,
                          ...
                          s = r.concat(e.data)
                        return (
                          (s.length >= o.comments || e.data.length < i) &&
                            (u = !0),
                          n.setState({
                            comments: s,
                            isLoadOver: u,
              ...
              (n.handlePopup = function(e) {
                ...
                var t = !n.state.isPopupVisible,
                  r = function e(t) {
                    ;(0, C.hasClassInParent)(t.target, 'gt-user', 'gt-popup') ||
                      (window.document.removeEventListener('click', e),
                      n.setState({ isPopupVisible: !1 }))
                  }
                n.setState({ isPopupVisible: t }),
                  t
              ...
              (n.handleIssueCreate = function() {
                n.setState({ isIssueCreating: !0 }),
                  n
                    .createIssue()
                    .then(function(e) {
                      return (
                        n.setState({ isIssueCreating: !1, isOccurError: !1 }),
                        n.getComments(e)
                      )
                    })
                    .catch(function(e) {
                      n.setState({
                        isIssueCreating: !1,
                        isOccurError: !0,
                        errorMsg: (0, C.formatErrorMsg)(e)
                      })
                    })
              }),
              (n.handleCommentCreate = function(e) {
                if (!n.state.comment.length)
                  return e && e.preventDefault(), void n.commentEL.focus()
                n.setState({ isCreating: !0 }),
                  n
                    .createComment()
                    .then(function() {
              ...
              (n.handleCommentPreview = function(e) {
                n.setState({ isPreview: !n.state.isPreview }),
                  C.axiosGithub
                    .post(
                      '/markdown',
              ...
              (n.handleCommentKeyDown = function(e) {
                n.options.enableHotKey &&
                  (e.metaKey || e.ctrlKey) &&
                  13 === e.keyCode &&
                  (n.publicBtnEL && n.publicBtnEL.focus(),
                  n.handleCommentCreate())
              }),
            ...
            var r = window.localStorage.getItem(F.GT_COMMENT)
            r &&
              ((n.state.comment = decodeURIComponent(r)),
              window.localStorage.removeItem(F.GT_COMMENT))
            var o = (0, C.queryParse)()
            if (o.code) {
              var i = o.code
              delete o.code
              var a =
              ...
              history.replaceState(null, null, a),
                ...
                C.axiosJSON
                  .post(n.options.proxy, {
                    code: i,
                    client_id: n.options.clientID,
                    client_secret: n.options.clientSecret
                  })
                  .then(function(e) {
                    e.data && e.data.access_token
                      ? ((n.accessToken = e.data.access_token),
                        n
                          .getInit()
                          .then(function() {
                      ...
                      : (console.log('res.data err:', e.data),
                        n.setState({
                          isOccurError: !0,
                          errorMsg: (0, C.formatErrorMsg)(
            ...
            return (n.i18n = (0, M.default)(n.options.language)), n
          }
          return (
            (0, g.default)(t, e),
            (0, p.default)(t, [
              ...
              },
              {
                ...
                value: function() {
                  var e = this,
                    ...
                    n = this.state.issue
                  return n
                    ? (this.setState({ isNoInit: !1 }), i.default.resolve(n))
                    : 'number' == typeof t && t > 0
                    ? this.getIssueById().then(function(t) {
                    ...
                    .post(
                      '/repos/' + n + '/' + r + '/issues',
                      {
                        ...
                        body:
                          ...
                          s +
                            ' \n\n ' +
                            ((0, C.getMetaContent)('description') ||
                              (0, C.getMetaContent)(
                                'description',
                                'og:description'
                              ) ||
                ...
                value: function(e) {
                  if (e)
                    return this.accessToken
                      ? G.default.call(this, e)
                      : this.getCommentsV3(e)
                }
              },
              {
                key: 'createComment',
              ...
              },
              {
                ...
                value: function() {
                  this.setState({ user: null }),
                    window.localStorage.removeItem(F.GT_ACCESS_TOKEN)
                }
              },
              {
                key: 'like',
                    ...
                    .then(function(n) {
                      ;(a = a.map(function(t) {
                        return (
                          t.id === e.id &&
                            (t.reactions
                              ? ~t.reactions.nodes.findIndex(function(e) {
                                  return e.user.login === i.login
                                }) || (t.reactions.totalCount += 1)
                              : ((t.reactions = { nodes: [] }),
                                (t.reactions.totalCount = 1)),
                            t.reactions.nodes.push(n.data),
                            (t.reactions.viewerHasReacted = !0)),
                          t
                        )
                      })),
              ...
              },
              {
                ...
                value: function() {
                  return b.default.createElement(
                    ...
                    b.default.createElement('i', { className: 'gt-loader' }),
              ...
              },
              {
                ...
                value: function() {
                  var e = this,
                    ...
                    f = r.concat([])
                  return (
                    'last' === a && this.accessToken && f.reverse(),
                    b.default.createElement(
                      'div',
                      ...
                      b.default.createElement(
                        ...
                        f.map(function(t) {
                          return b.default.createElement(j.default, {
                            ...
                            likeCallback:
                              t.reactions && t.reactions.viewerHasReacted
                                ? e.unLike.bind(e, t)
                                : e.like.bind(e, t)
                          })
                        })
              ...
              },
              {
                ...
                value: function() {
                  ...
                  if (s && '[object Function]' === {}.toString.call(s))
                    try {
                      s(a)
                    } catch (e) {
                      console.log(
                    ...
                    b.default.createElement('span', {
                      ...
                      dangerouslySetInnerHTML: {
                        __html: this.i18n.t('counts', {
                          counts:
                            '<a class="gt-link gt-link-counts" href="' +
                            (n && n.html_url) +
                            '" target="_blank">' +
                            a +
                            '</a>',
                    ...
                    r &&
                      b.default.createElement(
                        ...
                        t
                          ? b.default.createElement(P.default, {
                              className:
                                'gt-action-sortdesc' + (u ? ' is--active' : ''),
              ...
              },
              {
                ...
                value: function() {
                  ...
                  return b.default.createElement(
                    ...
                    !t &&
                      (n ? [this.noInit()] : [this.header(), this.comments()])
                  )
                }
              },
              {
                ...
                get: function() {
                  return (
                    this._accessToke ||
                    window.localStorage.getItem(F.GT_ACCESS_TOKEN)
                  )
                },
                set: function(e) {
                  window.localStorage.setItem(F.GT_ACCESS_TOKEN, e),
                    (this._accessToken = e)
                }
              },
              {
    ...
    function(e, t, n) {
      n(50), n(19), n(26), n(94), n(102), n(103), (e.exports = n(0).Promise)
    },
    function(e, t, n) {
      var r = n(32),
        o = n(33)
    ...
    function(e, t, n) {
      ...
      k ||
        ((N = function(e) {
          h(this, N, 'Promise', '_h'), p(e), r.call(this)
          try {
        ...
        (b.f = A = function(e) {
          return e === N || e === a ? new i(e) : o(e)
        })),
        f(f.G + f.W + f.F * !k, { Promise: N }),
        n(25)(N, 'Promise'),
        n(101)('Promise'),
        (a = n(0).Promise),
        f(f.S + f.F * !k, 'Promise', {
    ...
    function(e, t, n) {
      n(106), (e.exports = n(0).Object.assign)
    },
    function(e, t, n) {
      var r = n(4)
    ...
    function(e, t, n) {
      ...
      e.exports =
        ...
        n(13)(function() {
          ...
          ? function(e, t) {
              for (
                var n = u(e), c = arguments.length, l = 1, f = i.f, d = a.f;
                c > l;
                ...
                for (
                  ...
                  (p = m[g++]), (r && !d.call(h, p)) || (n[p] = h[p])
              return n
            }
          : c
    },
    function(e, t, n) {
      n(109), (e.exports = n(0).Object.getPrototypeOf)
    },
    function(e, t, n) {
      var r = n(16),
        o = n(56)
    ...
    function(e, t, n) {
      n(19), n(26), (e.exports = n(43).f('iterator'))
    },
    function(e, t, n) {
      e.exports = { default: n(113), __esModule: !0 }
    },
    function(e, t, n) {
      n(114), n(50), n(119), n(120), (e.exports = n(0).Symbol)
    },
    function(e, t, n) {
      'use strict'
      var r = n(1),
        ...
        Z = function(e) {
          ...
          return (
            !(this === z && o(R, e) && !o(H, e)) &&
            (!(t || !o(this, e) || !o(R, e) || (o(this, L) && this[L][e])) || t)
          )
        },
        Q = function(e, t) {
          if (((e = x(e)), (t = _(t, !0)), e !== z || !o(R, t) || o(H, t))) {
            var n = A(e, t)
            return (
              !n || !o(R, t) || (o(e, L) && e[L][t]) || (n.enumerable = !0), n
            )
          }
        },
        ee = function(e) {
          for (var t, n = P(x(e)), r = [], i = 0; n.length > i; )
            o(R, (t = n[i++])) || t == L || t == s || r.push(t)
          return r
        },
        te = function(e) {
          for (
            var t, n = e === z, r = P(n ? H : x(e)), i = [], a = 0;
            r.length > a;

          )
            !o(R, (t = r[a++])) || (n && !o(z, t)) || i.push(R[t])
          return i
        }
      X ||
        ((D = function() {
          ...
          return i && q && U(z, e, { configurable: !0, set: t }), W(e)
        }),
        ...
        (n(27).f = Z),
        (N.f = te),
        i && !n(20) && u(z, 'propertyIsEnumerable', Z, !0),
        (h.f = function(e) {
          return W(p(e))
        })),
        a(a.G + a.W + a.F * !X, { Symbol: D })
      for (
        ...
        p(ne[re++])
      for (var oe = T(p.store), ie = 0; oe.length > ie; ) m(oe[ie++])
      a(a.S + a.F * !X, 'Symbol', {
        for: function(e) {
          return o(G, (e += '')) ? G[e] : (G[e] = D(e))
        },
        keyFor: function(e) {
      ...
      a(a.S + a.F * ae, 'Object', {
        ...
        D.prototype[F] || n(10)(D.prototype, F, D.prototype.valueOf),
        f(D, 'Symbol'),
        f(Math, 'Math', !0),
        f(r.JSON, 'JSON', !0)
    },
    ...
    function(e, t, n) {
      n(123), (e.exports = n(0).Object.setPrototypeOf)
    },
    function(e, t, n) {
      var r = n(4)
    ...
    function(e, t, n) {
      ...
      var p = n(131),
        ...
        m = n(134),
        v = n(46),
        g = (0, m.whichTransitionEvent)(),
        y = !g,
        b = (function(e) {
          function t() {
            var e, n, r, a
            o(this, t)
            for (var l = arguments.length, d = Array(l), p = 0; p < l; p++)
              d[p] = arguments[p]
            return (
              (n = r = i(
                this,
              ...
              (r.childrenData = {}),
              (r.parentData = { domNode: null, boundingBox: null }),
              (r.heightPlaceholderData = { domNode: null }),
              (r.remainingAnimations = 0),
              (r.childrenToAnimate = []),
              (r.runAnimation = function() {
                r.state.children
                  .filter(r.doesChildNeedToBeAnimated)
                  .forEach(function(e, t) {
                    ;(r.remainingAnimations += 1),
                      r.childrenToAnimate.push(u(e)),
                      r.animateChild(e, t)
                  }),
                  'function' == typeof r.props.onStartAll &&
            ...
            l(t, [
              ...
              },
              {
                ...
                value: function(e) {
                  ...
                  this.setState({
                    children: this.isAnimationDisabled(e)
                      ? t.map(function(e) {
              ...
              },
              {
                key: 'componentDidUpdate',
                value: function(e) {
                  var t = f.Children.toArray(this.props.children).map(function(
                      e
                    ) {
                      return e.key
                    }),
              ...
              },
              {
                ...
                value: function(e) {
                  var t = this,
                    ...
                    r = 0
                  return (
                    this.state.children.forEach(function(o, i) {
                      if (
                        !e.find(function(e) {
                          return e.key === u(o)
                        }) &&
                  ...
                  if (n) {
                    this.state.children
                      ...
                      .forEach(function(t) {
                        ...
                        n.boundingBox &&
                          (0, m.removeNodeFromDOMFlow)(
                            n,
                            e.props.verticalAlignment
                          )
                      }),
                      r &&
                        this.heightPlaceholderData.domNode &&
                        (0, m.updateHeightPlaceholder)({
              ...
              },
              {
                ...
                value: function(e, t) {
                  ...
                  o &&
                    ...
                    this.props.onStart && this.props.onStart(e, o),
                    requestAnimationFrame(function() {
                      requestAnimationFrame(function() {
                        ...
                        e.appearing && n.props.appearAnimation
                          ? (r = c({}, r, n.props.appearAnimation.to))
                          : e.entering && n.props.enterAnimation
                          ? (r = c({}, r, n.props.enterAnimation.to))
                          : e.leaving &&
                            n.props.leaveAnimation &&
                            (r = c({}, r, n.props.leaveAnimation.to)),
                          (0, m.applyStylesToDOMNode)({ domNode: o, styles: r })
                      })
                    }),
                ...
                value: function(e) {
                  ...
                  if (r) {
                    var o = function n(o) {
                      o.target === r &&
                        ((r.style.transition = ''),
                        t.triggerFinishHooks(e, r),
                        r.removeEventListener(g, n),
                        e.leaving && t.removeChildData(u(e)))
                    }
              ...
              },
              {
                ...
                value: function(e, t) {
                  var n = this
                  if (
                    (this.props.onFinish && this.props.onFinish(e, t),
                    ...
                    this.setState({ children: r }, function() {
                      'function' == typeof n.props.onFinishAll &&
                        n.callChildrenHook(n.props.onFinishAll),
                        (n.childrenToAnimate = [])
                    }),
                      this.heightPlaceholderData.domNode &&
              ...
              },
              {
                ...
                value: function(e) {
                  ...
                  this.childrenToAnimate.forEach(function(e) {
                    ...
                    o &&
                      (n.push(o),
                      t.hasChildData(e) && r.push(t.getChildData(e).domNode))
                  }),
                    e(n, r)
                }
              },
              ...
              },
              {
                ...
                value: function(e) {
                  return (
                    y ||
                    e.disableAllAnimations ||
                    (0 === e.duration &&
                      0 === e.delay &&
                      0 === e.staggerDurationBy &&
                      0 === e.staggerDelayBy)
                  )
                }
              },
              ...
              },
              {
                ...
                value: function() {
                  var e = this,
                    ...
                    n = 'ul' === t || 'ol' === t,
                    r = n ? 'li' : 'div'
                  return d.default.createElement(r, {
              ...
              },
              {
                ...
                value: function() {
                  ...
                  return this.state.children.map(function(t) {
                    return d.default.cloneElement(t.element, {
                      ref: function(n) {
                        if (n) {
              ...
              },
              {
                ...
                value: function() {
                  ...
                  return (
                    o && i && u.push(this.createHeightPlaceholder()),
                    d.default.createElement(n, a, u)
                  )
                }
              }
            ]),
                ...
                l(n, [
                  {
                    ...
                    value: function(e) {
                      if ('production' !== v) {
                        ...
                        }) || (0, p.statelessFunctionalComponentSupplied)()
                      }
                    }
                  },
                  {
                    ...
                    value: function(e) {
                      var t = {
                        ...
                        staggerDelayBy: this.convertTimingProp(
                          'staggerDelayBy'
                        ),
                      ...
                      this.checkForStatelessFunctionalComponents(t.children),
                        void 0 !== e.disableAnimations &&
                          ('production' !== v &&
                            (0, p.deprecatedDisableAnimations)(),
                          (t.disableAllAnimations = e.disableAnimations))
                      var n = Object.keys(t),
                        r = (0, m.omit)(this.props, n)
                      return (
                        (r.style = c({ position: 'relative' }, r.style)),
                        (t.delegated = r),
                        t
                      )
                    }
    ...
    function(e, t, n) {
      ...
      t.appearPresets = r
      ;(r.accordianVertical = r.accordionVertical),
        (r.accordianHorizontal = r.accordionHorizontal),
        (o.accordianVertical = o.accordionVertical),
        (o.accordianHorizontal = o.accordionHorizontal)
      ...
      ;(t.getRelativeBoundingBox = function(e) {
        ...
        (t.getPositionDelta = function(e) {
          var t = e.childDomNode,
            ...
            o = e.getPosition,
            i = { top: 0, left: 0, right: 0, bottom: 0, height: 0, width: 0 },
            a = n || i,
            u = r || i,
            s = o(t),
...
*/
    ...
    function(e, t, n) {
      ...
      Object.defineProperty(t, '__esModule', { value: !0 }),
        (t.default = function(e) {
          return new i.default({ phrases: s[e] || s.en, locale: e })
        })
      var o = n(137),
        i = r(o),
        a = n(138),
    ...
    function(e, t, n) {
      ...
      !(function(n, i) {
        ...
        function o(e, t, n) {
          ...
          return (
            null != n && e
              ? ((i = e.split(l)), (u = i[a(t, n)] || i[0]), (o = r(u)))
              : (o = e),
            o
          )
        }
        ...
        ;(t.VERSION = '0.4.3'),
          ...
          (t.prototype.t = function(e, t) {
            ...
            return (
              (t = null == t ? {} : t),
              'number' == typeof t && (t = { smart_count: t }),
              ...
              'string' == typeof n &&
                ((t = c(t)),
                (r = o(n, this.currentLocale, t.smart_count)),
                (r = u(r, t))),
              r
            )
          }),
    ...
    function(e, t, n) {
      n(142), (e.exports = n(0).Object.keys)
    },
    function(e, t, n) {
      var r = n(16),
        o = n(21)
    ...
    function(e, t, n) {
      ...
      t.default = function(e) {
        ...
        return o.default.createElement(
          ...
          o.default.createElement('span', { className: 'gt-btn-text' }, a),
          u &&
            o.default.createElement('span', {
    ...
    function(e, t, n) {
      ...
      t.default = function(e) {
        ...
        return o.default.createElement(
          'a',
          { className: 'gt-action ' + t, onClick: n },
                    ...
                    m.default.createElement(
                      ...
                      m.default.createElement(
                        ...
                        m.default.createElement('div', {
                          className: 'gt-comment-block-' + (n ? '2' : '1')
                        }),
                        m.default.createElement(
                          'a',
                          {
                        ...
                        m.default.createElement(
                          ...
                          (0, x.default)(t.created_at, {
                            addSuffix: !0,
                            locale: {
                              distanceInWords:
                                window.GT_i18n_distanceInWordsLocaleMap[r]
                            }
                          })
                        ),
                        d &&
    ...
    function(e, t, n) {
      function r(e, t, n) {
        ...
        if (_ < c) {
          return m('aboutXHours', Math.round(_ / 60), y)
        }
        if (_ < l) return m('xDays', 1, y)
        if (_ < f) {
          return m('xDays', Math.round(_ / c), y)
        }
        if (_ < d) return (b = Math.round(_ / f)), m('aboutXMonths', b, y)
        if ((b = u(g, v)) < 12) {
          return m('xMonths', Math.round(_ / f), y)
        }
        var E = b % 12,
          S = Math.floor(b / 12)
        return E < 3
          ...
          return (
            (o =
              'string' == typeof t[e]
                ...
                ? t[e].one
                : t[e].other.replace('{{count}}', n)),
            r.addSuffix ? (r.comparison > 0 ? o + '內' : o + '前') : o
          )
        }
        var t = {
          ...
          return (
            (o =
              'string' == typeof t[e]
                ...
                ? t[e].one
                : t[e].other.replace('{{count}}', n)),
            r.addSuffix ? (r.comparison > 0 ? 'en ' + o : 'hace ' + o) : o
          )
        }
        var t = {
          lessThanXSeconds: {
          ...
          return (
            (o =
              'string' == typeof t[e]
                ...
                ? t[e].one
                : t[e].other.replace('{{count}}', n)),
            r.addSuffix ? (r.comparison > 0 ? 'dans ' + o : 'il y a ' + o) : o
          )
        }
        var t = {
          lessThanXSeconds: {
    ...
    function(e, t, n) {
      ...
      function r(e) {
        var t = this,
          ...
          d = f.cursor,
          p = f.comments
        return a.axiosGithub
          .post(
            '/graphql',
            u({ owner: r, repo: o, id: e.number, pageSize: s, cursor: d }, c),
            { headers: { Authorization: 'bearer ' + this.accessToken } }
          )
          .then(function(n) {
            ...
            s =
              'last' === c
                ? [].concat((0, i.default)(u), (0, i.default)(p))
                : [].concat((0, i.default)(p), (0, i.default)(u))
            var f =
              !1 === a.pageInfo.hasPreviousPage || !1 === a.pageInfo.hasNextPage
            return (
              t.setState({
                comments: s,
                isLoadOver: f,
      ...
      var o = n(201),
        ...
        u = function(e, t) {
          ...
          return (
            null === e.cursor && delete e.cursor,
            { operationName: 'getIssueAndComments', query: r, variables: e }
          )
        }
      t.default = r
    },
    ...
    function(e, t, n) {
      n(19), n(204), (e.exports = n(0).Array.from)
    },
    function(e, t, n) {
      'use strict'
      var r = n(12),
