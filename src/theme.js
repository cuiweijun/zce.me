...
// theme.breakpoints = ['640px', '768px', '1024px', '1280px']
  ...
  send: {
    ...
    path: (
      <g
        ...
        <path d="M29.333 2.667l-14.667 14.667"></path>
        <path d="M29.333 2.667l-9.333 26.667-5.333-12-12-5.333 26.667-9.333z"></path>
      </g>
    )
  }
}
