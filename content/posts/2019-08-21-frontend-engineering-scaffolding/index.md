...
![选择项目类型](android-scaffolding-2.png)

三、填写项目属性和相关配置

![填写项目属性和相关配置](android-scaffolding-3.png)

四、得到基础的项目骨架结构

![得到项目结构](android-scaffolding-4.png)
...
这些工具的实现方式也都大同小异，无外乎就是根据你提供的一些信息自动生成一个项目所需要的特定文件结构及相关配置。不过它们一般只用于自生所服务的框架项目。
