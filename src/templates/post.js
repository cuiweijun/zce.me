        ...
        <footer className="post-footer">
          ...
          <section className="license">
            ...
            <svg width="160" viewBox="0 0 120 42" aria-hidden="true">
                <path fill="#fff" d="M3.4,0.5l113.4,0.2c1.6,0,3-0.2,3,3.2l-0.1,37.3H0.5V3.7C0.5,2,0.7,0.5,3.4,0.5z"/>
            ...
            <p>This work is licensed under a <a href="https://creativecommons.org/licenses/by-sa/4.0/" target="_blank" rel="license">Creative Commons Attribution-ShareAlike 4.0 International License</a></p>
          </section>
        </footer>
      </article>
