...
export default ({ as: Tag = 'article', post, rel }) => (
  ...
  >
    ...
    {post.fields.cover ? (
      ...
      // prettier-ignore
      <svg viewBox="0 0 540 360" css={{ maxHeight: '25rem', background: '#66d9e8' }}>
        <title>{post.fields.title}</title>
        <path fill="#339af0" d="M280.7,142.5v14.7H210.6V142.5h1.8l9.2,4.1,4.1-4.1Z" />
        <path fill="#1b78be" d="M195.5,151.3l-7-17.8L171,141.2l-1.4-1.4,7.6-17.5-17.8-7v-.5l17.8-7-7.6-17.6.3-.4,17.5,7.6,7-17.8h.5l7,17.8,17.6-7.7,1.4,1.4-7.7,17.5,17.8,7v.5l-17.8,7,7.7,17.6-.4.3-17.6-7.7-7,17.7-.4.3ZM195.2,98a17.67,17.67,0,0,0-17.7,17.7,17,17,0,0,0,2.5,8.9,17.7,17.7,0,1,0,23.9-24.4A19,19,0,0,0,195.2,98Z" />
    ...
    >
      <span css={t => ({ color: t.colors.muted, textTransform: 'uppercase' })}>
      ...
      />
      <p css={{ flex: 1 }} children={post.excerpt} />
      <footer
        css={t => ({
          display: 'flex',
          alignItems: 'center',
